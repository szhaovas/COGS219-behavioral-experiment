...
jsPsych.plugins['reconstruction'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      stimulus: {
        ...
        default: undefined,
        description: 'The stimulus you wish to use in the reconstruction.'
      },
      starting_value: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function draw(param, stim) {

      //console.log(param);

      display_element.innerHTML = '<div id="jspsych-reconstruction-stim-container">'+trial.stim_function(param, stim)+'</div>';
